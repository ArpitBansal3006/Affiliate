...
function AnalyticsDashboard() {
    ...
    const fetchLinkAnalytics = async () => {
        try {
            ...
            console.log(error);
            //Navigate to user page if we're not able to fetch the link analytics
            //This is because there is no point rendering the component if we don't have any data
            navigate('/error');
        }
    };
